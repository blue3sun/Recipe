...
public class CategoryListAdapter extends BaseAdapter<Category,CategoryListAdapter.MenuViewHolder> {
    ...
    public void onBindViewHolder(MenuViewHolder holder, int position) {
        ...
        Category category = mLists.get(position);
        if (category == null || StringUtils.isNull(category.getName())){
            holder.tvMenuName.setVisibility(View.GONE);
        }else{
            holder.tvMenuName.setText(category.getName());
            holder.tvMenuName.setTag(category);
